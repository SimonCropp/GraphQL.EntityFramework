...
public partial class IntegrationTests : TestBase
{
    ...
    {
        GlobalFilters.Add<FilterParentEntity>((context, item) => { return item.Property != "Ignore"; });
        GlobalFilters.Add<FilterChildEntity>((context, item) => { return item.Property != "Ignore"; });
