    ...
    where TDbContext : DbContext
{
    ...
    #region Simplified API - AddProjectedSingleField (resolve returns projected IQueryable)
    ...
    #region Simplified API - AddProjectedFirstField (resolve returns projected IQueryable)
    ...
    #region Simplified API - AddProjectedQueryField (resolve returns projected IQueryable)
    ...
    #region Simplified API - AddProjectedQueryConnectionField (resolve returns projected IOrderedQueryable)
