...
public partial interface IEfGraphQLService<TDbContext>
{
    ...
    FieldBuilder<TSource, TReturn> AddProjectedFirstField<TSource, TEntity, TProjection, TReturn>(
    ...
    FieldBuilder<object, TReturn> AddProjectedFirstField<TEntity, TProjection, TReturn>(
        IComplexGraphType graph,
        string name,
