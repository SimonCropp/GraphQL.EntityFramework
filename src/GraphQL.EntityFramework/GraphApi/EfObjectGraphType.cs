    ...
    where TSource : class
{
    ...
    #region AddProjectedField (navigation projection from TSource)
    ...
    #region AddProjectedListField (list projection from TSource)
    ...
    #region AddProjectedConnectionField (connection projection from TSource)
