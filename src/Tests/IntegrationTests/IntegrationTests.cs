public partial class IntegrationTests
{
    ...
    public async Task LogQuery()
    {
        ...
        var query =
            ...
            {
              parentEntities
              (where: {and: [{property: {startsWith: "Valu"}}, {property: {endsWith: "ue3"}}]})
              {
                property
              }
            }
    ...
    public async Task Where_multiple()
    {
        var query =
            ...
            {
              parentEntities
              (where: {property: {startsWith: "Valu", endsWith: "ue3"}})
              {
                property
              }
            }
    ...
    public async Task Where_date_notEqual()
    {
        var query =
            """
            {
              dateEntities (where: {property: {notEqual: "2020-10-01"}})
              {
                id
              }
            }
    ...
    public async Task Where_enum()
    {
        var query =
            """
            {
              enumEntities (where: {property: {equal: THURSDAY}})
              {
                id
              }
            }
    ...
    public async Task Where_enum_notEqual()
    {
        var query =
            """
            {
              enumEntities (where: {property: {notEqual: THURSDAY}})
              {
                id
              }
            }
    ...
    public async Task Where_enum_in()
    {
        var query =
            """
            {
              enumEntities (where: {property: {in: [THURSDAY]}})
              {
                id
              }
            }
    ...
    public async Task Where_time_notEqual()
    {
        var query =
            """
            {
              timeEntities (where: {property: {notEqual: "10:11:00"}})
              {
                id
              }
            }
    ...
    public async Task Like()
    {
        var query =
            """
            {
              parentEntities (where: {property: {like: "value2"}})
              {
                property
              }
            }
    ...
    public async Task Where_with_variable()
    {
        var query =
            ...
            query ($value: String!)
            {
              parentEntities (where: {property: {equal: $value}})
              {
                property
              }
            }
    ...
    public async Task Where_with_variable_notEqual()
    {
        var query =
            ...
            query ($value: String!)
            {
              parentEntities (where: {property: {notEqual: $value}})
              {
                property
              }
            }
    ...
    public async Task Where()
    {
        var query =
            """
            {
              parentEntities (where: {property: {equal: "value2"}})
              {
                property
              }
            }
    ...
    public async Task Where_sql_injection()
    {
        var query =
            """
            {
              parentEntities (where: {property: {equal: "'; DROP TABLE ParentEntities; --"}})
              {
                property
              }
            }
    ...
    public async Task Where_notEqual()
    {
        var query =
            """
            {
              parentEntities (where: {property: {notEqual: "value2"}})
              {
                property
              }
            }
    ...
    public async Task In()
    {
        var query =
            """
            {
              parentEntities (where: {property: {in: ["value2"]}})
              {
                property
              }
            }
    ...
    public async Task Null_on_nested()
    {
        var query =
            """
            {
              level1Entities(where: {level2Entity: {level3EntityId: {equal: "00000000-0000-0000-0000-000000000003"}}})
              {
                level2Entity
                {
                  level3Entity
    ...
    public async Task Null_on_nested_notEqual()
    {
        var query =
            """
            {
              level1Entities(where: {level2Entity: {level3EntityId: {notEqual: "00000000-0000-0000-0000-000000000003"}}})
              {
                level2Entity
                {
                  level3Entity
    ...
    public async Task ManyToManyRightWhereAndInclude()
    {
        var query =
            """
            {
              manyToManyLeftEntities (where: {rights: {any: {rightName: {equal: "Right2"}}}})
              {
                leftName
                rights
                {
    ...
    public async Task ManyToManyRightWhereAndInclude_notEqual()
    {
        var query =
            """
            {
              manyToManyLeftEntities (where: {rights: {any: {rightName: {notEqual: "Right2"}}}})
              {
                leftName
                rights
                {
    ...
    public async Task ManyToManyLeftWhereAndInclude()
    {
        var query =
            """
            {
              manyToManyRightEntities (where: {lefts: {any: {leftName: {equal: "Left2"}}}})
              {
                rightName
                lefts
                {
    ...
    public async Task ManyToManyLeftWhereAndInclude_notEqual()
    {
        var query =
            """
            {
              manyToManyRightEntities (where: {lefts: {any: {leftName: {notEqual: "Left2"}}}})
              {
                rightName
                lefts
                {
